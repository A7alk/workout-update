...
def macros():
    ...
    if nutrition.button("Generate with AI"):
        # Get the macros generated by AI
        result = get_macros(profile.get("general"), profile.get("goals"))
        
        # Debug: Print the result from AI to check if it's correct
        print("Macros generated by AI:", result)
        
        # Update the profile with the AI-generated macros
    ...
    with nutrition.form("nutrition_form"):
        ...
        if st.form_submit_button("Save"):
            with st.spinner():
                # Update st.session_state.profile with the form values
                st.session_state.profile = update_personal_info(
                    profile,
                    "nutrition",
                    protein=protein,
